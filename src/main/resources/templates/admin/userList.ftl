...
<div class="panel">
    <div class="panel-body">
        <form class="form-horizontal" action="/lxw2000/user/list" method="get">
            <div class="form-group">
                ...
                <div class="col-sm-1">
                    <a href="/lxw2000/user/list" class="btn btn-success">查询全部</a>
                </div>
            </div>
        </form>
    </div>
...
<div class="modal fade" id="userUpdateModal">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="/lxw2000/user/update" method="post">
...
<script type="text/javascript">
    ...
    function getNewData(pageNumber) {
        ...
        window.location.href = "/lxw2000/user/list?pageNumber=" + pageNumber + "<#if (userName?? && userName?length>0)>&userName=${userName!}</#if>";
    }
