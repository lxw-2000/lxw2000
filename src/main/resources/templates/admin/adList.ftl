        ...
        <#if adTypeList?? && adTypeList?size gt 0>
            <#list adTypeList as adType>
                <li class="list-group-item">
                    <a href="/lxw2000/ad/list?adTypeId=${(adType.adTypeId)!}">
                        ${(adType.adTypeTitle)!}
                    </a>
    ...
    <div class="panel col-sm-12">
        <div class="panel-body">
            ...
            <table class="table table-bordered">
                ...
                <tr>
                    <th>广告图片</th>
                    <th style="width: 100px;text-align: center;">广告类型</th>
                    <th style="width: 130px;text-align: center;">广告标题</th>
                    <th style="width: 100px;text-align: center;">广告开始时间</th>
                    <th style="width: 100px;text-align: center;">广告结束时间</th>
                    <th style="width: 100px;text-align: center;">添加广告的时间</th>
                    <th>操作</th>
                </tr>
                </thead>
                <tbody>
...
<script>
    ...
    function subAdTypeUpdate() {
        ...
        $.post("/lxw2000/ad/type/addOrUpdate", {
                adTypeId: adTypeId,
