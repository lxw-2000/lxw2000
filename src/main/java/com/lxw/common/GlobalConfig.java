package com.lxw.common;


import com.lxw.intercepter.AdminInterceptor;
import com.lxw.intercepter.GlobalInterceptor;
import com.lxw.intercepter.UserInterceptor;
...
public class GlobalConfig implements WebMvcConfigurer {
    ...
    public void addInterceptors(InterceptorRegistry registry) {
        ...
        registry.addInterceptor(getAdminInterceptor())
                .addPathPatterns("/lxw2000/**")
                .excludePathPatterns("/lxw2000/login", "/lxw2000/logout", "/lxw2000/adminLogin");
